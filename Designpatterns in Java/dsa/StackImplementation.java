...
public class StackImplementation {
	public static void main(String[] args) {
		...
		System.out.println("Popped element: " + stack.pop()); // Output: Popped
		// element: 40
		...
		// Check if the stack is empty
		System.out.println("Is stack empty? " + stack.isEmpty()); // Output: Is stack
		// empty? false

		// Check if the stack is full
		System.out.println("Is stack full? " + stack.isFull()); // Output: Is stack
		// full? false
	}
}